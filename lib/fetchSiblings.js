...
module.exports = function fetchSiblings(urls, page, parentData, config) {

  if (!page.urlToChildren && (!page.resToSiblings || page.siblingsIndex < 0)) {
    return fetchAll({
      url: urls,
      page,
      siblings: urls,
  ...
  if (page.urlToChildren) {
    urls.forEach((u, i, a) => {
      data.push({
        page: { data: null },
        children: page.urlToChildren(u, i, a, parentData),
        siblings: []
      });
    });
    return data;
